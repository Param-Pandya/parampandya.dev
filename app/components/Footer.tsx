...
export default function Footer(): React.JSX.Element {
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-md text-white/80 max-w-2xl mx-auto mb-8">
            I’m always open to discussions around <span className="text-purple-400">AI/ML research</span>, 
            collaborative projects, and research-driven opportunities in healthcare and intelligent systems.
        ...
        <div className="flex justify-center gap-6 mt-12">
          <Link
            href="https://www.instagram.com/p.aaraam/"
            target="_blank"
  ...
  © {new Date().getFullYear()} Param Pandya. All rights reserved.
  <br />
  <span className="text-white/40 text-xs">
    Design inspired by Ibrahim Memon.
  </span>
</p>
